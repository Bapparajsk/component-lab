        ...
        <div
          ...
          <div
            ...
            <div className={"w-full h-auto mt-8"}>
              ...
              <SyntaxHighlighter
                ...
                lineProps={(lineNumber) => {
                  ...
                  if (lineNumber >= 21 && lineNumber <= 30) {
            ...
            <div className={"h-auto w-full relative mt-8"}>
              <div className={"w-full h-auto"}>
                <p><code
                  className={"relative rounded bg-neutral-400/60 px-[0.3rem] py-[0.2rem] text-sm dark:bg-neutral-700/70 dark:text-neutral-200 __className_faaa9a"}>components/ui/macbook-scroll.tsx</code>
                </p>
                <div className={cn("w-full h-52 overflow-y-hidden", isShowExampleCode && "h-auto overflow-y-auto")}>
                  <SyntaxHighlighter
                    language={"jsx"}
              ...
              <div
                className={cn("absolute h-52 w-full bottom-0 flex items-center justify-center",
                  isShowExampleCode && "h-14",
                  !isShowExampleCode && "bg-[rgba(0,0,0,0.49)] shadow-[0px_0px_100px_20px_rgba(0,0,0,0.75)_inset]"
                )}>
                <Button variant={"faded"} color={"default"} onPress={() => {
                  setIsShowExampleCode(!isShowExampleCode);
                }}>{isShowExampleCode ? "Collapse" : "Expand"}</Button>
